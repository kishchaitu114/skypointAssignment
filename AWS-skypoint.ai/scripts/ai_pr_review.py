#!/usr/bin/env python3
# Copy of repo-root scripts/ai_pr_review.py for standalone aws/ CI paths.
# Canonical source: ../../scripts/ai_pr_review.py
"""AI-assisted PR review — see root scripts/ai_pr_review.py for full documentation."""
import json
import os
import sys
